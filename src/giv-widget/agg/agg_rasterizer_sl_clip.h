...
namespace agg
{
    ...
    struct ras_conv_int_sat
    {
        ...
        { 
          return saturation<poly_max_coord>::iround(v * unsigned(poly_subpixel_scale)); 
        }
        static int downscale(int v) { return v; }
    };
    ...
    struct ras_conv_int_3x
    {
        ...
        static int yi(int v) { return v; }
        static int upscale(double v) { return iround(v * unsigned(poly_subpixel_scale)); }
        static int downscale(int v)  { return v; }
    };
    ...
    struct ras_conv_dbl
    {
        ...
        static int xi(double v) { return iround(v * unsigned(poly_subpixel_scale)); }
        static int yi(double v) { return iround(v * unsigned(poly_subpixel_scale)); }
    ...
    struct ras_conv_dbl_3x
    {
        ...
        static int xi(double v) { return iround(v * unsigned(poly_subpixel_scale) * 3); }
        static int yi(double v) { return iround(v * unsigned(poly_subpixel_scale)); }
        static double upscale(double v) { return v; }
        static double downscale(int v)  { return v / double(poly_subpixel_scale); }
    };
